...
function Trending() {
  ...
  const baseurl = `https://api.themoviedb.org/3/trending/all/day?api_key=d6808d0ad50276bc5f432c356ac53f7a`;
  ...
  return (
    <div className="OuterDiv">
      ...
      <div className="categoryWise_Movie_container_background trending_page">
        <div className="simillar_title_category trending_title">
          Trending And Popular Movies and Series
        </div>
                ...
                <Link
                  to={
                    item.media_type == "movie"
                      ? `/moviefulldetail/${item.id}`
                      : `/tvfulldetail/${item.id}`
                  }
                >
                  <img
