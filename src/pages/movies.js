...
function Movies() {
  ...
  const baseurl = `https://api.themoviedb.org/3/trending/movie/week?api_key=d6808d0ad50276bc5f432c356ac53f7a`;
  ...
  return (
    <div className="OuterDiv">
      ...
      <div className="categoryWise_Movie_container_background trending_page">
        <div className="simillar_title_category ">Movies of the Week </div>
