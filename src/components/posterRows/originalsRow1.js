...
function OriginalsRow1() {
    ...
    async function fetchnetflixdata() {
      ...
      for (let index = 1; index <= 1; index++) {
        const response = await axios.get(
          `https://api.themoviedb.org/3/discover/tv?language=en-US&api_key=d6808d0ad50276bc5f432c356ac53f7a&with_networks=213&page=${index}`
        );
  ...
  return (
    <div className="netflixrow_background background originalRow1">
    <div className="row_title">Netflix Originals</div>
