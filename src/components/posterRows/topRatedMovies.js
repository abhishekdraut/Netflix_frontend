...
function TopRatedRowMovies() {
    ...
    async function fetchnetflixdata() {
      ...
      for (let index = 1; index <= 1; index++) {
        const response = await axios.get(
          `https://api.themoviedb.org/3/movie/top_rated?api_key=d6808d0ad50276bc5f432c356ac53f7a&language=en-US&page=${index}`
        );
  ...
  return (
    <div className="netflixrow_background background">
      <div className="row_title">Top Rated Movies</div>
...
export default TopRatedRowMovies;
