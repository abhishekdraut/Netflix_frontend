...
function TrendingRowTv() {
    ...
    async function fetchnetflixdata() {
      ...
      for (let index = 1; index <= 1; index++) {
        const response = await axios.get(
            `https://api.themoviedb.org/3/trending/tv/week?api_key=d6808d0ad50276bc5f432c356ac53f7a&page=${index}`
        );
  ...
  return (
    <div className="netflixrow_background background">
      <div className="row_title">Trending series of the week</div>
